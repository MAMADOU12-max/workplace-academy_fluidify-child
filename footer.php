            ...
            <div class="col-md-3 ">
                <section class="footer-area footer-area-two">
                    ...
                    <div class="textwidget"><p>
                        <a href="/opleiding/" class="text-white">Opleiding</a><br />
                        <a href="/workshops/" class="text-white">Workshops</a><br />
                        <a href="/masterclasses/" class="text-white">Masterclasses</a> <br>
                        <a href="/events/" class="text-white">Events</a></p>
                    </div>
		        </section>   
            </div>
            ...
            <div class="col-md-3">
                <section class="footer-area footer-area-three"><h4>Workplace Academy</h4>		
                	<div class="textwidget"><p>
                        ...
                        <a href="/agenda/" class="text-white">Agenda</a> <br>
                        <a href="/contact/" class="text-white">Contact</a></p>
                    </div>
		        </section>           
            </div>
