        ...
        <div class="row flex-column-reverse flex-md-row align-items-center d-flex justify-content-center">
            <div class="col-md-5">
                ...
                <!-- <noscript class="ninja-forms-noscript-message"> -->
                    </noscript><div id="nf-form-4-cont" class="nf-form-cont" aria-live="polite" aria-labelledby="nf-form-title-4" aria-describedby="nf-form-errors-4" role="form">
                <?php
                ...
                <div class="theme-form__second-col">
                    <div class="text-default">
                        ...
                        <p><span style="font-weight: 400;">
                            Twijfel niet en neem contact met ons op! Samen kijken wij
                            naar de beste opleidingsmogelijkheden voor jou of jouw organisatie.
                        </span></p>
                    </div>
                </div>
            </div>
