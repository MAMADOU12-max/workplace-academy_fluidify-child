    ...
    <div class="theme-hero <?php echo get_field('fdfd_bg_color'); ?>">
        <div class="container">
            <div class="row flex-column-reverse flex-md-row align-items-center d-flex justify-content-center">
                <div class="col-md-5">
                    <h2 class="hero-title">De toekomstbestendige werkomgeving vereist</h2>
                    ...
                    <a href="#" class="btn btn-default theme-button bg__secondary px-4">
                        <strong>Plan afspraak in</strong>
                    </a>
                </div>
...
<!-- 
            <div class="row d-flex justify-content-center mt-5  align-items-center flex-column-reverse flex-md-row">    
                <div class="col-md-5 m-2 ">
                    ...
                    <div class="my-1 bg-accent">
                        <strong class="fw-bold"> 
                            ...
                            <span class=" theme-card_star-icon text-dark">&#8364;</span> 
                            <span class="mb-1 note text-dark">700</span> 
                        </strong>
                    </div>
                    <div class="theme-hero__content default-text ">
                        Wij noemen dit workplace management. Leer van de experts op het gebied van facility management, human resource management, duurzaamheid, IT, mobiliteit, vastgoed, bouw en gezondheid.
            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="col-md-5">
                    ...
                    <a href="#" class="btn btn-default theme-button bg__lightblue px-4 my-2">
                        <strong class="text-dark">Neem contact op</strong> 
                    </a>
