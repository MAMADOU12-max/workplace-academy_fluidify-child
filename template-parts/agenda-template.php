...
<body class="page-template-default page page-id-63 wp-custom-logo">
    ...
    <div class="main">
        ...
        <div class="wrapper">
            ...
            <div class="container">
                <div class="row my-5 flex-column-reverse flex-md-row align-items-center">
                    <div class="col-md-6">
                        ...
                        <a href="https://workplaceacademy.nl/" class="btn btn-default theme-button bg__secondary">Ik heb een vraag</a>            </div>
                    <div class="col-md-6">
    ...
    <div class="blockFrontAgenda">
        <div class="container px-0">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12 col-11 mb-4">
...
<div class="theme-slider bg__primary">
