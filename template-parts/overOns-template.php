...
<?php /** Template Name: OverOns template */ ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center mx-auto col-12">
                        <h2>De workplace manager in opmars</h2>
                        <div class="default-text">De werkplek &#8211;  juist nu tijdens de coronacrisis, maar zeker ook daarna &#8211; wordt een belangrijk thema op de agenda van iedere organisatie. Want hoe worden deze werkplekken georganiseerd, ontworpen en ingericht? Dit zijn  vraagstukken waar een workplace manager mee te maken krijgt. De workplace academy wijst professionals en deskundigen de weg in dit nieuwe integrale domein.</div>
                    </div>
                </div>
            </div>
        </div>
