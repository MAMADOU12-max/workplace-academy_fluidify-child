    ...
    <div class="container">
        <div class="row flex-column-reverse flex-md-row align-items-center">
            <div class="col-md-6">
                ...
                <div class="theme-hero__content default-text">Aan de hand van relevante en actuele thema&#8217;s ontwikkelen wij hoogwaardige leermodules waarmee je met een beperkte tijdsinspanning op de hoogte bent van alle kennis en vaardigheden omtrent het desbetreffende thema. Kijk hieronder naar onze huidige workshops. </div>
                <a href="https://workplaceacademy.nl/contact/" class="btn btn-default theme-button bg__secondary">Neem direct contact met ons op </a>            </div>
            <div class="col-md-6">
                <img src="https://workplaceacademy.nl/wp-content/uploads/2021/02/basisopleiding-workplace-manager.png" style="height:auto;">
            </div>
        </div>
    </div>
</div>
...
<a href="/agenda/" class="text-white">Agenda</a></p>
            ...
            <div class="col-md-3">
                <section class="footer-area footer-area-three"><h4>Meld je aan voor de nieuwsbrief</h4>			<div class="textwidget"><noscript class="ninja-forms-noscript-message">
    Kennisgeving: Voor dit product is een JavaScript vereist.</noscript><div id="nf-form-2_1-cont" class="nf-form-cont form-subscribe" aria-live="polite" aria-labelledby="nf-form-title-2_1" aria-describedby="nf-form-errors-2_1" role="form">

    <div class="nf-loading-spinner"></div>

</div>
        <!-- TODO: Move to Template File. -->
        <script>var formDisplay=1;var nfForms=nfForms||[];var form=[];form.id='2_1';form.settings={"objectType":"Form Setting","editActive":true,"title":"Nieuwsbrief aanmelding","show_title":0,"allow_public_link":0,"embed_form":"","clear_complete":1,"hide_complete":1,"default_label_pos":"hidden","wrapper_class":"form-subscribe","element_class":"","key":"","add_submit":0,"changeEmailErrorMsg":"Voer een geldig e-mailadres in!","changeDateErrorMsg":"Vul een geldige datum in!","confirmFieldErrorMsg":"Deze velden moeten overeenkomen","fieldNumberNumMinError":"Fout met minimumaantal","fieldNumberNumMaxError":"Fout met maximumaantal","fieldNumberIncrementBy":"Toenemen met ","formErrorsCorrectErrors":"Corrigeer de fouten voordat je dit formulier indient.","validateRequiredField":"Dit is een verplicht veld.","honeypotHoneypotError":"Honeypot-fout","fieldsMarkedRequired":"Velden die gemarkeerd zijn met een <span class=\"ninja-forms-req-symbol\">*<\/span> zijn verplichte velden.","currency":"","repeatable_fieldsets":"","unique_field_error":"A form with this value has already been submitted.","logged_in":false,"not_logged_in_msg":"","sub_limit_msg":"The form has reached its submission limit.","calculations":[],"formContentData":["jouw_e-mailadres_1614628437304","aanmelden_1613415466567"],"drawerDisabled":false,"ninjaForms":"Ninja Forms","fieldTextareaRTEInsertLink":"Koppeling invoegen","fieldTextareaRTEInsertMedia":"Media invoegen","fieldTextareaRTESelectAFile":"Selecteer een bestand","formHoneypot":"Als je een persoon bent die dit veld ziet, laat je het leeg.","fileUploadOldCodeFileUploadInProgress":"Bestand wordt ge\u00fcpload.","fileUploadOldCodeFileUpload":"BESTANDSUPLOAD","currencySymbol":"&#36;","thousands_sep":".","decimal_point":",","siteLocale":"nl_NL","dateFormat":"m\/d\/Y","startOfWeek":"1","of":"van","previousMonth":"Vorige maand","nextMonth":"Volgende maand","months":["Januari","Februari","Maart","April","Mei","Juni","Juli","Augustus","September","Oktober","November","December"],"monthsShort":["Jan","Feb","Mrt","Apr","Mei","Jun","Jul","Aug","Sep","Okt","Nov","Dec"],"weekdays":["Zondag","Maandag","Dinsdag","Woensdag","Donderdag","Vrijdag","Zaterdag"],"weekdaysShort":["Zon","Maa","Din","Woe","Don","Vri","Zat"],"weekdaysMin":["Zo","Ma","Di","Wo","Do","Vr","Za"],"currency_symbol":"","beforeForm":"","beforeFields":"","afterFields":"","afterForm":""};form.fields=[{"objectType":"Field","objectDomain":"fields","editActive":false,"order":1,"idAttribute":"id","type":"email","label":"Jouw e-mailadres","key":"jouw_e-mailadres_1614628437304","label_pos":"hidden","required":1,"default":"","placeholder":"Jouw e-mailadres","container_class":"","element_class":"","admin_label":"","help_text":"","custom_name_attribute":"email","personally_identifiable":1,"value":"","drawerDisabled":false,"id":"5_1","beforeField":"","afterField":"","parentType":"email","element_templates":["email","input"],"old_classname":"","wrap_template":"wrap"},{"objectType":"Field","objectDomain":"fields","editActive":false,"order":2,"idAttribute":"id","label":"Aanmelden","type":"submit","processing_label":"Verwerken...","container_class":"","element_class":"","key":"aanmelden_1613415466567","drawerDisabled":false,"id":"6_1","beforeField":"","afterField":"","value":"","label_pos":"hidden","parentType":"textbox","element_templates":["submit","button","input"],"old_classname":"","wrap_template":"wrap-no-label"}];nfForms.push(form);</script>
		...
		<noscript>
			<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WRL632F" height="0" width="0" style="display:none;visibility:hidden"></iframe>
		</noscript>
		<!-- End Google Tag Manager (noscript) -->
		<link rel='stylesheet' id='dashicons-css'  href='https://workplaceacademy.nl/wp-includes/css/dashicons.min.css?ver=5.8.2' type='text/css' media='all' />
<link rel='stylesheet' id='nf-display-css'  href='https://workplaceacademy.nl/wp-content/plugins/ninja-forms/assets/css/display-opinions-light.css?ver=5.8.2' type='text/css' media='all' />
<link rel='stylesheet' id='nf-font-awesome-css'  href='https://workplaceacademy.nl/wp-content/plugins/ninja-forms/assets/css/font-awesome.min.css?ver=5.8.2' type='text/css' media='all' />
<script type='text/javascript' src='https://workplaceacademy.nl/wp-content/themes/fluidify/assets/js/main.js?ver=1.1' id='theme-script-js'></script>
<script type='text/javascript' src='https://workplaceacademy.nl/wp-content/themes/fluidify-child/main.js?ver=3.5' id='child-script-js'></script>
<script type='text/javascript' src='https://workplaceacademy.nl/wp-content/themes/fluidify-child/assets/js/libs/slickjs/slick.min.js?ver=3.5' id='slick-js'></script>
<script type='text/javascript' src='https://workplaceacademy.nl/wp-includes/js/wp-embed.min.js?ver=5.8.2' id='wp-embed-js'></script>
<script type='text/javascript' src='https://workplaceacademy.nl/wp-includes/js/underscore.min.js?ver=1.13.1' id='underscore-js'></script>
<script type='text/javascript' src='https://workplaceacademy.nl/wp-includes/js/backbone.min.js?ver=1.4.0' id='backbone-js'></script>
<script type='text/javascript' src='https://workplaceacademy.nl/wp-content/plugins/ninja-forms/assets/js/min/front-end-deps.js?ver=3.5.0' id='nf-front-end-deps-js'></script>
...
<script type='text/javascript' src='https://workplaceacademy.nl/wp-content/plugins/ninja-forms/assets/js/min/front-end.js?ver=3.5.0' id='nf-front-end-js'></script>
